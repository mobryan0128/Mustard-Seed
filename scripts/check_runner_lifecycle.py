...
def _settings(
    ...
    *,
    ...
    return KalshiSettings(
        ...
        live_quiet_continuation_enabled=live_quiet_continuation_enabled,
        live_quiet_continuation_max_recent_bps=Decimal("6"),
        live_quiet_continuation_max_3m_abs_bps=Decimal("12"),
        live_quiet_continuation_max_5m_abs_bps=Decimal("20"),
        live_quiet_continuation_max_5m_range_bps=Decimal("25"),
        live_quiet_continuation_block_deceleration=True,
        live_quiet_continuation_block_near_extreme=True,
        live_quiet_continuation_min_distance_from_extreme_bps=Decimal("5"),
        live_exhaustion_guard_enabled=True,
        live_exhaustion_burst_3m_bps=Decimal("20"),
        live_exhaustion_burst_5m_bps=Decimal("30"),
        live_exhaustion_near_extreme_bps=Decimal("3"),
        ...
        live_early_momentum_max_entry_price=Decimal("0.50"),
        live_ev_max_actual_cost=Decimal("0.70"),
        live_ev_min_reward_dollars=Decimal("0.30"),
        live_ev_require_positive_cost_expected_value=True,
        live_ev_exhaustion_block_enabled=True,
        live_candidate_funnel_diagnostics_enabled=(
            live_candidate_funnel_diagnostics_enabled
        ),
        live_weak_momentum_stabilization_min_distance=None,
        live_weak_momentum_max_range=None,
        live_weak_momentum_max_price=None,
        live_mini_exhaustion_enabled=False,
        live_mini_exhaustion_3m_bps=Decimal("12"),
        live_mini_exhaustion_range_bps=Decimal("25"),
        live_mini_exhaustion_recent_bps=Decimal("6"),
        live_bias_recent_return_min=None,
        live_bias_lookback_return_min=None,
        live_min_cross_distance_bps=Decimal("0"),
        live_adaptive_thresholds_enabled=False,
        live_composite_score_enabled=False,
        live_composite_score_min=Decimal("0.60"),
        live_composite_borderline_min=Decimal("0.50"),
        live_return_range_ratio_enabled=False,
        live_return_range_ratio_min_by_product={},
        live_progression_memory_enabled=False,
        live_progression_memory_window_cycles=8,
        live_progression_memory_max_age_seconds=600,
        live_retry_degradation_enabled=False,
        live_retry_score_decay=Decimal("0.10"),
        live_reversal_classifier_enabled=False,
        live_reversal_shadow_only=True,
        live_reversal_max_executable_price=Decimal("0.60"),
        live_reversal_min_ev=Decimal("0.00"),
        live_reversal_low_stake_max_dollars=Decimal("1.00"),
        live_reversal_min_probability=Decimal("0.60"),
        live_unified_near_extreme_enabled=False,
        live_unified_near_extreme_base_bps_by_product={},
        live_adaptive_chop_enabled=False,
        live_adaptive_pacing_enabled=False,
        live_product_volatility_scale_by_product={},
        live_score_telemetry_enabled=False,
        live_shadow_decision_log_enabled=False,
        live_score_aware_ev_cap_enabled=False,
        live_score_aware_ev_cap_bump=Decimal("0.05"),
        live_score_aware_ev_cap_max_by_product={},
        live_cold_start_high_ratio_block_enabled=True,
        live_cold_start_high_ratio_min=Decimal("3.00"),
        live_cold_start_overextension_distance_bps=Decimal("5"),
        live_cold_start_burst_block_enabled=True,
        live_high_score_danger_cap_enabled=True,
        live_high_score_danger_cap_min_score=Decimal("0.80"),
        live_high_score_danger_cap_max_score=Decimal("0.49"),
        live_continuation_major_danger_combo_block_enabled=True,
        live_quiet_exhaustion_conflict_block_enabled=True,
        live_quiet_exhaustion_conflict_min_composite=Decimal("0.75"),
        live_quiet_exhaustion_conflict_min_ratio=Decimal("1.00"),
        live_quiet_exhaustion_conflict_max_ratio=Decimal("2.00"),
        live_quiet_exhaustion_conflict_max_distance_abs_bps=Decimal("1.00"),
        live_quiet_exhaustion_conflict_cap_score=Decimal("0.49"),
        live_quiet_exhaustion_conflict_require_cold_start=True,
        live_quiet_exhaustion_conflict_require_impulse_conflict=True,
        live_quiet_exhaustion_conflict_require_recent_direction_mismatch=True,
        runner_enabled=True,
